...
//add some differen messages

console.log("hello world");

//fix the next syntax error

console.log('I'm awesome');

// declare a variable x and assign it a number. Print the number and the description in words

// declare a varibale y and assign it a string. Print the variable and a description of what it will be

// declare an array with your favourite animals. Use push and pop to remove and add some animals. Use shift and unshift to do the same.

// Write a program that checks the types of two variables and prints out SAME TYPE if they are the same type.

// Array

// Show in code if: you can store multiple types in an array? 

//Find a way to make the next string more readable

let myString = "hello,this,is,a,difficult,to,read,sentence";

// Add meerkat to the next array between blowfish and capricorn
